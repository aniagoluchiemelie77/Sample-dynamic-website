    ...
    <section class="newpost_body">
        ...
        if ($post_id1 > 0) {
            ...
            if ($getpost_result->num_rows > 0) {
                ...
                renderEditPostForm($base_url, $translations, $post_id1, $title, $subtitle, $category, $link, $image, $foreign_imagePath, $content, $author_firstname, $author_lastname, $author_bio, $usertype);
            }
        } else if ($post_id2 > 0) {
