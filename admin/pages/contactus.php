...
<body>
    ...
    $textarea_name = 'contactus_content';
    $textareaId = 'myTextarea';
    $submitbtn_name = 'contactus_editbtn';
    ...
    <script>
        const editAboutBtn3 = document.getElementById("Edit_about1");
        const editTextEditor3 = document.getElementById("hidden_aboutdiv1");
