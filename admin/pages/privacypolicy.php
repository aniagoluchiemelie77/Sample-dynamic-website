...
<body>
    ...
    <section class="about_section">
        <div class="page_links">
            <a href="../admin_homepage.php">Home</a> > <p>Pages</p> > <p>Privacy Policy</p>
        </div>
        ...
        <form class="about_editdiv" action="../forms.php" method="post" id="hidden_aboutdiv">
            <textarea class="about_editdiv-input" name="privacy_policy" id="myTextarea"></textarea>
            <input type="submit" value="Update" name="edit_privacypolicy_btn" />
        </form>
    </section>
