    ...
    if (isset($_POST['edit_aboutwebsite_btn'])) {
        $content = $_POST['terms-of-service'];
    ...
    <body>
        ...
        <section class="about_section">
            <div class="page_links">
                <a href="../admin_homepage.php"><?php echo $translations['home']; ?></a> > <p><?php echo $translations['pages']; ?></p> > <p>Terms Of Service</p>
            </div>
            ...
            <form class="about_editdiv" action=" " method="post" id="hidden_aboutdiv1">
                <textarea class="about_editdiv-input" name="terms-of-service" id="myTextarea6"></textarea>
