...
<body>
    ...
    $textarea_name = 'work_withus';
    $textareaId = 'myTextarea';
    $submitbtn_name = 'workwithus_editbtn';
    ...
    <script>
        const editAboutBtn6 = document.getElementById("Edit_about1");
        const editTextEditor6 = document.getElementById("hidden_aboutdiv1");
