    ...
    <section class="sectioneer">
        <div class="posts_div1 postsdiv sectioneer_divcontainer">
            <div class="page_links">
                <a href="../admin_homepage.php">Home</a> > <p> Drafts</p>
            </div>
            ...
            <div class="posts_divcontainer border-gradient-side-dark">
                <?php
                    $select_drafts= "SELECT admin_id, editor_id, id, title, time, DATE_FORMAT(Date, '%M %d, %Y') as formatted_date, authors_firstname, authors_lastname FROM unpublished_articles ORDER BY id DESC LIMIT 5";
                        ...
                        while($row = $select_drafts_result->fetch_assoc()) {
                            ...
                            echo "<div class='posts_divcontainer_subdiv'>
                                    ...
                                    <div class='posts_divcontainer_subdiv2'>
                                        <p class='posts_divcontainer_p'><span> By: </span>$author_firstname $author_lastname ( $role )</p>
                                    </div>
