    ...
    <section class="sectioneer">
        <div class="posts_div1 postsdiv sectioneer_divcontainer">
            <div class="page_links">
                <a href="<?php echo $base_url . 'admin_homepage.php'; ?>"><?php echo $translations['home']; ?></a> > <p><?php echo $translations['posts']; ?></p> > <p><?php echo $translations['paid_posts']; ?></p>
            </div>
            ...
            <div class="posts_divcontainer border-gradient-side-dark">
                <div id="search-results">
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        if ($query !== "") {
                            $stmt = $conn->prepare("SELECT * FROM paid_posts WHERE title LIKE ? OR subtitle LIKE ? OR content LIKE ? OR authors_firstname LIKE ? OR authors_lastname LIKE ? ORDER BY id DESC LIMIT 5");
                            $searchTerm = "%" . $query . "%";
                            ...
                            if ($stmt->execute()) {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    <div class='posts_delete_edit'>
                                        <a class='users_edit' href='../edit/post.php?id1=" . $row["id"] . "&title=" . $row["title"] . "'>
                                            <i class='fa fa-pencil' aria-hidden='true'></i>
                                        </a>
                                        <a class='users_delete' onclick='confirmDeletePP2(" . $row['id'] . ")'>
                                        ...
                                        <form id='$formId' class='favouriteForm' action='../script.php' method='POST' data-id='" . $row['id'] . "'>
                                            ...
                                            <input type='hidden' name='isfavourite1' value='" . ($row['is_favourite'] === 'True' ? 'True' : 'False') . "'>
