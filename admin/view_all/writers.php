    ...
    <section class="sectioneer">
        <div class="posts_div1 postsdiv sectioneer_divcontainer">
            <div class="page_links">
                <a href="<?php echo $base_url . 'admin_homepage.php'; ?>"><?php echo $translations['home']; ?></a> > <p><?php echo $translations['users']; ?></p> > <p><?php echo $translations['view_writers']; ?></p>
            </div>
                                        ...
                                        echo "<div class='posts_divcontainer_subdiv editor_div'>
                                                ...
                                                <div class='editor_div-body'>
                                                    ...
                                                    <form action='../promote_writer.php' method='POST' class='posts_delete_edit'>
                                                        ...
                                                        <button type='submit' class='promote_button users_delete btn'>$translations[promote_message]</button>
                                                    </form>
