...
<head>
    ...
    <title><?php echo $translations['terms_of_services']; ?></title>
</head>
...
<body>
    ...
    <section class="about_section">
        <div class="page_links">
            <a href="../editor_homepage.php"><?php echo $translations['home']; ?></a> > <p><?php echo $translations['pages']; ?></p> > <p><?php echo $translations['terms_of_services']; ?>s</p>
        </div>
        <div class="about_header">
            <h1><?php echo $translations['terms_of_services']; ?></h1>
        </div>
        ...
        <button class="about_section_btn" id="Edit_about5"><?php echo $translations['edit']; ?>
