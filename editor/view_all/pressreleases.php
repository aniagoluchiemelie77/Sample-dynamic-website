    ...
    <section class="sectioneer">
        <div class="posts_div1 postsdiv sectioneer_divcontainer">
            ...
            <div class="posts_divcontainer border-gradient-side-dark">
                ...
                <?php
                $select_pressreleases = "SELECT id, admin_id, editor_id, title, time, DATE_FORMAT(Date, '%M %d, %Y') as formatted_date, authors_firstname, authors_lastname FROM press_releases ORDER BY id DESC LIMIT 100";
