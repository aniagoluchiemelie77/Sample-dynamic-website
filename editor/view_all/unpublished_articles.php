    ...
    <section class="sectioneer">
        <div class="posts_div1 postsdiv sectioneer_divcontainer">
            <div class="page_links">
                <a href="../editor_homepage.php"><?php echo $translations['home']; ?></a> > <p><?php echo $translations['view_drafts2']; ?></p>
            </div>
            ...
            <div class="posts_divcontainer border-gradient-side-dark">
                <div id="search-results">
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        if ($query !== "") {
                            $stmt = $conn->prepare("SELECT * FROM unpublished_articles WHERE title LIKE ? OR subtitle LIKE ? OR content LIKE ? ORDER BY id DESC LIMIT 5");
                            $searchTerm = "%" . $query . "%";
