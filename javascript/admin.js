...
function confirmDeletePP(postId, usertype, userFirstname) {
  Swal.fire({
    title: "Are you sure?",
    text: "You won't be able to revert this!",
    icon: "warning",
...
function confirmDeleteSubscriber(Id, userFirstname) {
  Swal.fire({
    title: "Are you sure?",
    text: "You won't be able to revert this!",
    icon: "warning",
...
function confirmDeleteNewslSubscriber(Id, userFirstname) {
  Swal.fire({
    title: "Are you sure?",
    text: "You won't be able to revert this!",
    icon: "warning",
...
function confirmDeleteEditor(Id, userFirstname) {
  Swal.fire({
    title: "Are you sure?",
    text: "You won't be able to revert this!",
    icon: "warning",
...
function disableInputs(clearValues = true) {
  ...
  countdownInterval = setInterval(function () {
    if (timeLeft <= 0) {
      ...
      const email = document.querySelector(
        'input[name="validate_otp_email"]'
      ).value;
      const anchor = document.createElement("a");
      anchor.textContent = "Resend OTP?";
      anchor.href =
        "verifyotp.php?resend_otp=1&email=" + encodeURIComponent(email);
      anchor.className = "resend-link";
