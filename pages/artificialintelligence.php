    ...
    <body id="container">
        ...
        <div class="body_container">
            <div class="body_left">
                ...
                <h1 class='bodyleft_header3'>Search Artificial Intelligence Posts</h1>
                <form class="header_searchbar2 search_input" id="search_form" action="artificialintelligence.php" method="get">
                        ...
                        if (isset($_GET['query'])) {
                            ...
                            if ($query !== "") {
                                foreach ($tables as $table) {
                                    $searchNiche = 'Artificial Intelligence';
