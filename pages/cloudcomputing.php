    ...
    <div class="body_container">
        <div class="body_left">
            <div class="page_links">
                <a href="../">Home</a> > <p>Cloud Computing</p>
            </div>
            <h1 class='bodyleft_header3'>Search Cloud Compuing Posts</h1>
            <form class="header_searchbar2 search_input" id="search_form" action="cloudcomputing.php" method="get">
            ...
            <h1 class='bodyleft_header3 border-gradient-bottom--lightdark'>Latest On Cloud Computing</h1>
        ...
        <div class="body_right border-gradient-leftside--lightdark">
            <div class="subscribe_container">
                <form class="sec2__susbribe-box other_width" method="POST" action="" id="susbribe-box">
                    ...
                    <p class="sec2__susbribe-box-p1">Get the latest Updates and Info from Uniquetechcontentwriter on Cloud Compuing, Artificial Intelligence and lots more.</p>
