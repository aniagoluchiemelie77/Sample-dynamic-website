...
if (isset($_GET['query'])) {
    ...
    if ($query !== "") {
        $stmt = $conn->prepare("SELECT * FROM ebooks WHERE title LIKE ?");
        $searchTerm = "%" . $query . "%";
    ...
    <div class="body_container">
        <div class="body_left">
            <div class="page_links">
                <a href="../">Home</a> > <p>Resources (Ebooks)</p>
            </div>
            <h1 class='bodyleft_header3'>Search Ebooks</h1>
            <form class="header_searchbar2 search_input" id="search_form" action="ebooks.php" method="get">
            ...
            <div class='more_posts'>
                <?php
                $sql = "SELECT name, resource_path, niche, title, date_added FROM ebooks ORDER BY id DESC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<p>No Ebooks Uploaded Yet.</p>";
                }
                ?>
            </div>
        </div>
