    ...
    <body id="container">
        ...
        <div class="body_container">
            <div class="body_left">
                ...
                <h1 class='bodyleft_header3'>Search Naija Latest Posts</h1>
                <form class="header_searchbar2 search_input" id="search_form" action="naijalatest.php" method="get">
                ...
                <h1 class='bodyleft_header3 border-gradient-bottom--lightdark'>More on Naija's Latest</h1>
            ...
            <div class="body_right border-gradient-leftside--lightdark">
                <div class="subscribe_container">
                    <form class="sec2__susbribe-box other_width" method="POST" action="" id="susbribe-box">
                        ...
                        <p class="sec2__susbribe-box-p1">Get the latest Updates and Info from Uniquetechcontentwriter on Naija's Latest, Artificial Intelligence and lots more.</p>
        ...
        <script>
            ...
            function submitSearch() {
                ...
                if (query.trim() !== "") {
                    fetch("naijalatest.php?query=" + encodeURIComponent(query))
