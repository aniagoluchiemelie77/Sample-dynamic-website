...
<body id="container">
    ...
    <div class="body_container">
        <div class="body_left">
            ...
            <h1 class='bodyleft_header3'>Search News Posts</h1>
            <form class="header_searchbar2 search_input" id="search_form" action="news.php" method="get">
        ...
        <div class="body_right border-gradient-leftside--lightdark">
            <div class="subscribe_container">
                <form class="sec2__susbribe-box other_width" method="POST" action="" id="susbribe-box">
                    ...
                    <p class="sec2__susbribe-box-p1">Get the latest Updates and Info from Uniquetechcontentwriter on News, Artificial Intelligence and lots more.</p>
