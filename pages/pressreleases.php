...
<body id="container">
    ...
    <div class="body_container">
        <div class="body_left">
            ...
            <h1 class='bodyleft_header3'>Search Press Releases</h1>
            <form class="header_searchbar2 search_input" id="search_form" action="pressreleases.php" method="get">
            ...
            <div id="search-results">
                <div id="results-container" class="more_posts">
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        $results = [];
                        if ($query !== "") {
                            $sql = "SELECT id, title, niche, content, image_path, Date FROM press_releases WHERE (title LIKE ? OR subtitle LIKE ? OR content LIKE ?) ORDER BY id DESC LIMIT 3";
