...
if (isset($_GET['query'])) {
    ...
    if ($query !== "") {
        $stmt = $conn->prepare("SELECT * FROM videoscripts WHERE title LIKE ?");
        $searchTerm = "%" . $query . "%";
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<img src='../images/videoscripts_img.png' alt='Whitepaper Image'/>";
...
<body id="container">
    ...
    <div class="body_container">
        <div class="body_left">
            <div class="page_links">
                <a href="../">Home</a> > <p>Resources (Videoscripts)</p>
            </div>
            <h1 class='bodyleft_header3'>Search Videoscripts</h1>
            ...
            <div class='more_posts'>
                <?php
                $sql = "SELECT name, resource_path, niche, title, date_added FROM videoscripts ORDER BY id DESC";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "  <a class='more_posts_subdiv' href='#'>
                                    <img src='../images/videoscripts_img.png' alt = 'Whitepaper Image'/>
                    ...
                    echo "<p>No Videoscripts Uploaded Yet.</p>";
                }
                ?>
            </div>
        </div>
    ...
    <script>
        ...
        function submitSearch() {
            ...
            if (query.trim() !== "") {
                fetch("videoscripts.php?query=" + encodeURIComponent(query))
