...
<body id="container">
    ...
    <div class="body_container">
        <div class="body_left">
            ...
            <h1 class='bodyleft_header3'>Search Vulnerabilities And Threats Posts</h1>
            <form class="header_searchbar2 search_input" id="search_form" action="vulnerabilitiesandthreats.php" method="get">
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        if ($query !== "") {
                            foreach ($tables as $table) {
                                $searchNiche = 'Vulnerabilities And Threats';
            ...
            <h1 class='bodyleft_header3 border-gradient-bottom--lightdark'>Latest Posts on Vulnerabilities and Threats</h1>
        ...
        <div class="body_right border-gradient-leftside--lightdark">
            <div class="subscribe_container">
                <form class="sec2__susbribe-box other_width" method="POST" action="" id="susbribe-box">
                    ...
                    <p class="sec2__susbribe-box-p1">Get the latest Updates and Info from Uniquetechcontentwriter on Vulnerabilities And Threats, Artificial Intelligence and lots more.</p>
    ...
    <script>
        ...
        function submitSearch() {
            ...
            if (query.trim() !== "") {
                fetch("vulnerabilitiesandthreats.php?query=" + encodeURIComponent(query))
